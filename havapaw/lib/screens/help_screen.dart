...
const _faqs = [
  {'q': 'How do I connect my pet\'s collar?', 'a': 'Go to the Connect Collar screen from the Health or Home page. Scan for available ESP32 devices and select your collar. Health and location data will sync automatically.'},
  {'q': 'How do I track my pet\'s location?', 'a': 'Connect your ESP32 smart collar to track your pet\'s location in real-time. The collar sends GPS data automatically which is displayed on the Map screen.'},
